...
const ASCIIBinaryTool: React.FC = () => {
	...
	const answerChars = currentMessage
		.split("")
	...
	return (
		<div className="w-full min-h-screen p-4 bg-linear-to-br from-blue-50 to-purple-50">
			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="p-4 mb-4 bg-white rounded-lg shadow-md">
					<div className="flex flex-wrap items-center justify-center gap-6">
						...
						<button
							...
							className="px-3 py-1 text-sm text-white bg-gray-600 rounded-lg cursor-pointer transition-colors hover:bg-gray-700"
							type="button"
						>
				...
				<details className="relative mb-6 bg-white rounded-lg shadow-lg">
					<summary className="p-6 cursor-pointer list-none [&::-webkit-details-marker]:hidden">
						<h3 className="text-xl font-bold">Instructions</h3>
					</summary>

					<div className="px-6 pb-6 -mt-2 text-gray-700">
						<p className="mb-2">
							<strong>
						...
						{gameMode === "practice" && (
							<p className="mt-2 text-sm text-blue-600">
								💡 Tip: Once you fill all the answers, press Enter to get a new
								word!
							</p>
						)}
						{gameMode === "test" && (
				...
				<div className="p-6 mb-6 bg-white rounded-lg shadow-lg">
					<div className="flex items-center justify-between mb-4">
						...
						<button
							...
							className="px-4 py-2 text-white bg-green-500 rounded-full cursor-pointer transition-colors hover:bg-green-600"
							type="button"
						>
					...
					{gameMode === "test" && isMarked && showAnswers && (
						<div className="p-4 mt-6 border border-yellow-200 rounded-lg bg-yellow-50">
							...
							<div className="flex flex-wrap gap-2">
								{answerChars.map(({ char, pos }) => (
									<div key={`answer-${pos}`} className="text-center">
