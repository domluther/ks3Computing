...
const PhishingGame = () => {
    ...
    const [feedback, setFeedback] = useState({ title: '', message: '', correct: false });
    ...
    const getEmails = (name: string, email: string): Email[] => [
        // --- Existing Emails ---
        {
            ...
            fromEmail: { text: 'winner@luckymail.net', isSuspicious: false, reason: "" },
            subject: { text: "CONGRATULATIONS! You've Won a New iPhone 16 Pro!", isSuspicious: true, reason: "Unexpected prize notifications that create extreme urgency are highly suspicious." },
            body: [
                { text: `Dear ${email},`, isSuspicious: true, reason: "They used your email address instead of your name. Legitimate companies usually use your real name." },
                { text: "You have been selected as our lucky winner of a brand new iPhone 16 Pro!", isSuspicious: false, reason: "" },
                { text: "To claim your prize, you must click here to verify your details immediately.", isSuspicious: true, reason: "Pressure to click a link to a suspicious URL is a common tactic.", url: "http://verify-details-now.com/winner" },
                { text: "This offer is only valid for 24 hours so act fast!", isSuspicious: true, reason: "Creating a sense of urgency is designed to make you panic and not think carefully." },
                { text: "Thank's,\nThe Super Offers Team", isSuspicious: true, reason: "Apostrophe misuse ('Thank's' instead of 'Thanks') is a common grammar error in phishing emails." },
            ]
        },
        {
            id: 2,
            ...
            fromEmail: { text: 'library@sandbachhigh.co.uk', isSuspicious: false, reason: "" },
            subject: { text: 'Overdue Library Book Reminder', isSuspicious: false, reason: "" },
            body: [
                { text: `Hi ${name},`, isSuspicious: false, reason: "" },
                { text: "Just a friendly reminder that your library book, 'The Hobbit', was due back last Friday.", isSuspicious: false, reason: "" },
                { text: "Please can you return it to the library as soon as possible so another student can borrow it.", isSuspicious: false, reason: "" },
                { text: "No worries about any fines, just bring it back when you can!", isSuspicious: false, reason: "" },
                { text: "Thanks,\nMrs. Davison\nSchool Librarian", isSuspicious: false, reason: "" },
            ]
        },
        {
            id: 3,
        ...
        },
        {
            ...
            fromEmail: { text: 'dluther@sandbachhigh.co.uk', isSuspicious: false, reason: "" },
        ...
        },
        {
            ...
            fromEmail: { text: 'help@sandbachhigh.co.uk.info', isSuspicious: true, reason: "The sender's email address ends in '.co.uk.info'. This is not the official school email address, which is a major warning sign." },
        ...
        },
        {
            ...
            fromEmail: { text: 'track@royalmail-gb.com', isSuspicious: true, reason: "This email domain looks real but isn't the official one ('royalmail.com'). Scammers use similar domains to trick you." },
            subject: { text: 'Your parcel is waiting for delivery', isSuspicious: false, reason: "" },
            body: [
                { text: "Hello,", isSuspicious: true, reason: "A generic greeting is suspicious. They would usually use your name if they had it." },
                { text: "We were unable to deliver your parcel today. A small redelivery fee of £1.99 is required.", isSuspicious: true, reason: "Royal Mail do not charge you a redelivery fee." },
                { text: "Please pay this fee by visiting our secure portal.", isSuspicious: true, reason: "Unexpected requests for payment, even small ones, are a huge red flag.", url: "http://royalmail-portal.co.uk/pay" },
                { text: "Your parcel will be returned too the sender if the fee is not paid in 2 days.", isSuspicious: true, reason: "Using the wrong word ('too' instead of 'to') is a sign of a poorly written, unprofessional email." },
            ]
        },
        {
            id: 7,
            ...
            fromEmail: { text: 'd.jones@sandbachhigh.co.uk', isSuspicious: false, reason: "" },
        ...
        },
        {
            ...
            fromEmail: { text: 'security-alert@yourbank.co.uk.net', isSuspicious: true, reason: "Scammers often add extra endings like '.net' to a real domain to make it look legitimate." },
            subject: { text: 'Action Required: Your Account has been Suspended', isSuspicious: false, reason: "" },
            body: [
        ...
        },
        {
            ...
            fromEmail: { text: 'invoice@quickbooks-online.co', isSuspicious: true, reason: "A legitimate domain for a UK business would likely be '.com' or '.co.uk', not just '.co'." },
            subject: { text: 'Invoice INV-0876 Due', isSuspicious: false, reason: "" },
            body: [
        ...
        },
        {
            ...
            fromEmail: { text: 'it.services@sandbachhigh.co.uk', isSuspicious: false, reason: "" },
            subject: { text: 'Planned Network Maintenance this Weekend', isSuspicious: false, reason: "" },
            body: [
                { text: "Hello all,", isSuspicious: false, reason: "" },
                { text: "Please be aware that we will be performing essential network maintenance this Saturday between 8 AM and 12 PM.", isSuspicious: false, reason: "" },
                { text: "During this time, access to the school network, including shared drives and some online services, may be intermittent.", isSuspicious: false, reason: "" },
                { text: "We apologise for any inconvenience this may cause.\n\nRegards,\nThe IT Team", isSuspicious: false, reason: "" },
            ]
        },
        {
            id: 15,
            ...
            fromEmail: { text: 'j.palin@sandbachhigh.co.uk', isSuspicious: false, reason: "" },
            subject: { text: 'Careers Fair - Next Week!', isSuspicious: false, reason: "" },
            body: [
        ...
        },
        {
            ...
            fromEmail: { text: 'noreply@vortex-games.com', isSuspicious: false, reason: "" },
            subject: { text: 'New achievement unlocked: First Quest!', isSuspicious: false, reason: "" },
            body: [
                { text: `Hey ${name},`, isSuspicious: false, reason: "" },
                { text: "Congrats on completing the 'Goblin's Cave' quest and unlocking your first achievement!", isSuspicious: false, reason: "" },
                { text: "Keep exploring the world of Eldoria. See what's next on your journey!", isSuspicious: false, reason: "" },
        ...
        },
        {
            id: 17,
            type: 'phishing',
            fromName: { text: 'FaceGram', isSuspicious: true, reason: "Scammers often invent names that sound like popular social media sites." },
            fromEmail: { text: 'friend-requests@facegram.social', isSuspicious: true, reason: "Using unusual domain endings like '.social' is a tactic to look modern, but it's not from an official site." },
            subject: { text: 'You have 1 new freind request', isSuspicious: true, reason: "Spelling mistakes like 'freind' are a major giveaway of a phishing attempt." },
            body: [
                { text: "Hi, a person you may know wants to be your freind on FaceGram.", isSuspicious: true, reason: "Repeating the 'freind' spelling mistake shows a lack of care." },
                { text: "View the request hear to accept or decline.", isSuspicious: true, reason: "Using the wrong word ('hear' instead of 'here') is another common grammatical error in scam emails.", url: "http://facegram.social/accept-now" },
                { text: "This link will expire in one hour.", isSuspicious: true, reason: "Creating urgency is a key tactic to make you click without thinking." },
            ]
        },
        {
            id: 18,
            ...
            fromEmail: { text: 'hello@codeclub.org', isSuspicious: false, reason: "" },
            subject: { text: 'Your new project awaits!', isSuspicious: false, reason: "" },
            body: [
        ...
        },
        {
            id: 19,
            type: 'phishing',
            fromName: { text: 'GameCoinz', isSuspicious: true, reason: "Made-up company names that promise free stuff are almost always a scam." },
            fromEmail: { text: 'free@game-coinz.xyz', isSuspicious: true, reason: "The '.xyz' domain is uncommon and often used for spam or scams." },
            subject: { text: 'FREE 5,000 ROBUX FOR YOU!', isSuspicious: true, reason: "Offers that are too good to be true, using all caps and exclamation marks, are classic signs of a scam." },
            body: [
                { text: "Hello Gamer!", isSuspicious: true, reason: "Using a generic term like 'Gamer' instead of your actual username is suspicious." },
                { text: "You have been selected to recieve 5,000 free Robux!", isSuspicious: true, reason: "Spelling mistakes like 'recieve' are unprofessional. Also, legitimate giveaways are rarely sent via unsolicited email." },
                { text: "To get your Robux, you must verify you're account on our secure portal.", isSuspicious: true, reason: "Grammar mistakes ('you're' instead of 'your') and requests to 'verify' an account on a strange site are huge red flags.", url: "http://get-robux-now-real.net" },
            ]
        },
        {
            id: 20,
            ...
            fromEmail: { text: 'notifications@youtube.com', isSuspicious: false, reason: "" },
            subject: { text: 'Your video upload is complete', isSuspicious: false, reason: "" },
            body: [
                { text: "Hello Creator,", isSuspicious: false, reason: "" },
                { text: "Good news! Your video, 'My Awesome Minecraft Build', has finished processing and is now live.", isSuspicious: false, reason: "" },
                { text: "Remember that all uploads must follow our community guidelines.", isSuspicious: false, reason: "" },
                { text: "Thanks for sharing,\nThe YouTube Team", isSuspicious: false, reason: "" },
            ]
        },
        {
            id: 21,
            ...
            fromEmail: { text: 'winner@youtubegiveaway.co', isSuspicious: true, reason: "The '.co' domain can be legitimate, but in this context, it's likely trying to imitate '.com'." },
            subject: { text: 'YOU WON! Claim Your Prize Now!', isSuspicious: true, reason: "Unexpected prize notifications that create extreme urgency are highly suspicious." },
            body: [
                { text: "CONGRATULATIONS! You have won our latest influencer giveaway! The prize is a new gaming PC.", isSuspicious: true, reason: "Winning a contest you never entered is a classic scam." },
                { text: "To claim, you must provide you're shipping details and pay a small £5.99 insurance fee.", isSuspicious: true, reason: "Legitimate prizes don't require you to pay a fee. This is a trick to get your card details.", url: "http://yt-giveaway-prizes.com/claim" },
                { text: "This must be done within 24 hours or we will select another winner.", isSuspicious: true, reason: "High pressure tactics are used to stop you from thinking carefully." },
            ]
        },
        {
            id: 22,
            ...
            body: [
                ...
                { text: "To view this document, please sign in with your school account.", isSuspicious: true, reason: "This link will lead to a fake login page to steal your school username and password.", url: "http://goooogle-docs-login.com/auth" },
                { text: "If you do not view this document your access may be restircted.", isSuspicious: true, reason: "Spelling errors ('restircted') and threats are signs of a phishing email." },
            ]
        }
    ];
    ...
    const handleInitialChoice = (choice: EmailType) => {
        ...
        if (isCorrect) {
            ...
            if (email.type === 'phishing') {
                ...
                setFeedback({ title: 'Correct!', message: "Well done! This was a legitimate email. You're getting good at telling the difference.", correct: true });
                setStage('feedback');
            }
        } else {
            if (email.type === 'legitimate') {
                setFeedback({ title: 'Incorrect', message: "This email was actually safe. Legitimate emails come from official addresses and are usually well-written.", correct: false });
            } else {
                setFeedback({ title: 'Oh no!', message: "This was a phishing email. It had several clues that it was a fake. Let's look at what they were.", correct: false });
            }
            setStage('feedback');
        }
    };
    ...
    const finishIdentifying = () => {
        const email = shuffledEmails[currentEmailIndex];
        const allClues = [email.fromName, email.fromEmail, email.subject, ...email.body].filter(p => p.isSuspicious);
    ...
    const renderIntro = () => (
        <div className="text-center p-8 max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-slate-800 mb-4">Spot the Phish! 🎣</h2>
            <p className="text-lg text-slate-600 mb-6">
                Phishing emails try to trick you. In this game, you'll learn how to spot them. You'll be shown {EMAILS_PER_GAME} emails—can you tell the real from the fake?
            </p>
            <p className="text-sm text-slate-500 mb-8 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <strong className="flex items-center justify-center mb-2"><AlertTriangle className="w-5 h-5 mr-2 text-amber-600" /> A Quick Note on Safety</strong>
                This game uses a name and email below to make the emails feel real, but <strong className="text-red-600">we do not save this information</strong>.
                Even so, it's always best practice not to use your real details on websites you don't know and trust.
            </p>
            <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
                <div className="mb-4">
                    <label htmlFor="name" className="flex items-center text-slate-700 font-semibold mb-2"><User className="w-5 h-5 mr-2" /> Name</label>
                    <input type="text" id="name" value={userName} onChange={(e) => setUserName(e.target.value)} className="w-full p-2 border border-slate-300 rounded-md" />
                </div>
                <div className="mb-6">
                    <label htmlFor="email" className="flex items-center text-slate-700 font-semibold mb-2"><AtSign className="w-5 h-5 mr-2" /> Email Address</label>
                    <input type="email" id="email" value={userEmail} onChange={(e) => setUserEmail(e.target.value)} className="w-full p-2 border border-slate-300 rounded-md" />
                </div>
    ...
    const renderEmail = (options: { isIdentifying?: boolean; isFeedback?: boolean; }) => {
        const { isIdentifying = false, isFeedback = false } = options;
        const email = shuffledEmails[currentEmailIndex];

        const ClickablePart = ({ clue, children }: { clue: ClickableClue, children: React.ReactNode }) => {
            ...
            if (isFeedback) {
                ...
                if (isIdentified) {
                    classParts.push("bg-green-100 border-l-4 border-green-500 font-semibold"); // Found during play: Green
                }
                if (isWrong) {
            ...
            const commonOnClick = isIdentifying ? (e: React.MouseEvent) => { 
            ...
            return (
                <span onClick={commonOnClick} className={combinedClassName}>
                    {children}
                </span>
            );
        };
            ...
            <div className="w-full max-w-3xl bg-white rounded-xl shadow-lg border border-slate-200">
                <div className="p-4 border-b border-slate-200">
                    <h3 className="text-xl font-bold text-slate-800">
                        <ClickablePart clue={email.subject}>{email.subject.text}</ClickablePart>
                    </h3>
                </div>
                <div className="p-4 border-b border-slate-200 bg-slate-50 text-sm text-slate-600">
                    <p>
                        <strong>From:</strong> <ClickablePart clue={email.fromName}>{email.fromName.text}</ClickablePart> &lt;<ClickablePart clue={email.fromEmail}>{email.fromEmail.text}</ClickablePart>&gt;
                    </p>
                ...
                <div className="p-6 space-y-4 text-slate-700">
                 ...
                 {isIdentifying && (
                    <div className="p-4 bg-yellow-50 border-t border-yellow-200 text-center">
                        <h4 className="font-bold text-yellow-800">Your Mission: Find the Clues!</h4>
                        <p className="text-yellow-700 mb-4">Click on all the parts of the email that look suspicious.</p>
                        <p className="font-bold text-lg mb-4 text-slate-700">Clues Found: {identifiedClues.length}</p>
                        {wrongClueId && <p className="text-red-600 font-semibold mb-2 animate-pulse">That looks safe. Try again!</p>}
                        <GameButton onClick={finishIdentifying}>I've found them all!</GameButton>
                    </div>
                )}
            </div>
        );
    ...
    const renderPlaying = () => (
        <div className="w-full max-w-3xl p-4 md:p-8">
            <p className="text-center text-gray-500 font-medium mb-4">Email {currentEmailIndex + 1} of {shuffledEmails.length}</p>
            {renderEmail({})}
            <div className="mt-6 text-center">
                <p className="text-xl font-semibold text-slate-700 mb-4">Is this a real email or a phishing attempt?</p>
                <div className="flex justify-center gap-4">
                    <button onClick={() => handleInitialChoice('phishing')} className="flex items-center justify-center gap-2 text-lg font-bold bg-red-500 text-white py-3 px-8 rounded-lg shadow-md hover:bg-red-600 transition-transform transform hover:scale-105">
                        <Fish className="w-6 h-6"/>Phishing
                    </button>
                    <button onClick={() => handleInitialChoice('legitimate')} className="flex items-center justify-center gap-2 text-lg font-bold bg-green-500 text-white py-3 px-6 rounded-lg shadow-md hover:bg-green-600 transition-transform transform hover:scale-105">
                        <Shield className="w-6 h-6"/>Legitimate
                    </button>
                </div>
            </div>
        </div>
    ...
    const renderFeedback = () => {
        const email = shuffledEmails[currentEmailIndex];
        const allClues = [email.fromName, email.fromEmail, email.subject, ...email.body].filter(p => p.isSuspicious && p.reason);

        return (
             <div className="w-full max-w-3xl p-4 md:p-8 text-center flex flex-col items-center gap-6">
                 <div className={`bg-white p-8 rounded-xl shadow-lg w-full border-t-8 ${feedback.correct ? 'border-green-500' : 'border-red-500'}`}>
                    {feedback.correct ? (
                    ...
                    {(email.type === 'phishing') && (
                        <div className="text-left bg-red-50 border-l-4 border-red-400 p-4 rounded-lg my-6">
                            <h4 className="font-bold text-lg mb-2 text-red-800">The reasons this was a phishing email:</h4>
                            <ul className="space-y-2 list-disc list-inside text-red-700">
                                {allClues.map(clue => (
                                    <li key={clue.reason} className={`${identifiedClues.includes(clue.reason) ? 'font-bold' : ''}`}>
                                        {clue.reason} 
                    ...
                    <div className='w-full'>
                        <p className='text-slate-600 font-semibold mb-2'>Here's a review of the email. Correctly spotted clues are green, missed ones are amber.</p>
                        {renderEmail({ isFeedback: true })}
                    </div>
                    )}

                    <GameButton onClick={handleNextEmail}>
                        {currentEmailIndex < shuffledEmails.length - 1 ? 'Next Email' : 'See Results'}
                    </GameButton>
                 </div>
            </div>
        )
    ...
    const renderResults = () => {
        const totalPossibleClues = shuffledEmails.reduce((acc, email) => {
            if (email.type === 'phishing') {
                const cluesInEmail = [email.fromName, email.fromEmail, email.subject, ...email.body].filter(p => p.isSuspicious);
        ...
        if (correctlyIdentifiedEmails === EMAILS_PER_GAME) {
            emailFeedback = "Perfect score! You have a brilliant eye for telling real emails from fakes.";
        } else if (correctlyIdentifiedEmails >= EMAILS_PER_GAME * 0.7) {
            emailFeedback = "Great work! You correctly identified most of the emails.";
        } else {
            emailFeedback = "Good start! Some emails tricked you, but practice makes perfect.";
        }
        
        let clueFeedback = '';
        if (totalPossibleClues > 0) {
            if (successfullyFoundClues >= totalPossibleClues * 0.8) {
                clueFeedback = "You're a master detective, spotting almost all the phishing clues!";
            } else if (successfullyFoundClues >= totalPossibleClues * 0.5) {
                clueFeedback = "You found a good number of clues, showing you know what to look for.";
            } else {
                clueFeedback = "You found some clues, which is great! Reviewing the tips below will help you spot even more next time.";
            }
        } else {
            clueFeedback = "No phishing emails were in your set, but you identified all the legitimate ones correctly!";
        }
        ...
        return (
            <div className="text-center p-8 max-w-3xl mx-auto">
                <div className="bg-white p-8 rounded-xl shadow-2xl border-t-8 border-blue-500">
                    ...
                    <h2 className="text-4xl font-bold mt-4 mb-2 text-slate-800">Game Over!</h2>
                    
                    <div className="my-8 space-y-4">
                        <div className="bg-slate-100 p-4 rounded-lg">
                            <p className="text-2xl font-bold text-slate-800">{correctlyIdentifiedEmails} / {EMAILS_PER_GAME}</p>
                            <p className="text-slate-600">Emails Correctly Identified</p>
                            <p className="text-sm mt-2 font-medium">{emailFeedback}</p>
                        </div>
                         <div className="bg-slate-100 p-4 rounded-lg">
                            <p className="text-2xl font-bold text-slate-800">{successfullyFoundClues} / {totalPossibleClues}</p>
    ...
    const renderStage = () => {
        switch (stage) {
            ...
            case 'identifying': return renderIdentifying();
